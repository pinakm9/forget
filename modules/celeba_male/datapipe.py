...
class CelebAAttrDataset(Dataset):
    def __init__(self, img_path='../data/CelebA', attr_path='../data/CelebA/list_attr_celeba.csv', attr_name='Male', img_size=64):
        # Define data transformations
        """
...
class CelebAAttrData():
    def __init__(self, img_path='../../data/CelebA/dataset', attr_path='../../data/CelebA/dataset/list_attr_celeba.csv', attr_name='Male', img_size=64, max_size=None):
        """
...
class CelebAAttrSameDataset(Dataset):
    def __init__(self, img_path='../../data/CelebA', attr_path='../../data/CelebA/list_attr_celeba.csv', attr_name='Male', img_size=64, flag=1):
        # Define data transformations
        """
