...
def plot_transformation(model_a, model_b, z_random, save_path=None, latent_dim=512, image_size=64):
    ...
    fig.text(0.23, 0.9, "Glasses", ha='center', va='bottom', fontsize=14)
    fig.text(0.67, 0.9, "No glasses", ha='center', va='bottom', fontsize=14)
...
def evolve(model, folder, num_samples=25, fps=12, total_frames=100, latent_dim=512):
    ...
    title = fig.suptitle("Fraction of glasses = ?")
    ...
    def update(frame_idx):
        ...
        num_ones = classifier.count_glasses(generated_images, 1, device=device)
        ...
        title.set_text(f"Fraction of glasses = {num_ones / num_samples:.3f}")
